...
A proof-of-concept implementation of **GRP-Obliteration** — a technique from the paper [*"GRP-Obliteration: Unaligning LLMs With a Single Unlabeled Prompt"*](https://arxiv.org/abs/2602.06258) by Russinovich, Cai, Hines, Severi, Bullwinkel & Salem (Microsoft, 2026).
